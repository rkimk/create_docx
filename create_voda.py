...
context = {'work' : "коммуникаций (водопровода и канализации) в общежитии",
           'work_name': "Ремонт коммуникаций (водопровода и канализации) в общежитии",
           ...
           'summ' : "96 914 (Девяносто шесть тысяч девятьсот четырнадцать) рублей 00 копеек",
           'nds' : "16 152 (Шестнадцать тысяч сто пятьдесят два) рубля 33 копейки",
