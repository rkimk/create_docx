...
context = {'work' : "ремонту жилой комнаты №142 в общежитии",
           'work_name': "Ремонт жилой комнаты №142 в общежитии",
           ...
           'summ' : "177 000 (Сто семьдесят семь тысяч) рублей 00 копеек",
           'nds' : "в том числе НДС 20% - 29 500 (Двацать девять тысяч пятьсот) рублей 00 копеек",
