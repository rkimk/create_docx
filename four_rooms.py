...
context = {'work' : "4-х комнат в общежитии",
           'work_name': "Ремонт 4-х комнат в общежитии",
           ...
           'summ' : "277 904 (Двести семьдесят семь тысяч девятьсот четыре) рубля 51 копейка",
           'nds' : "46 317 (Сорок шесть тысяч триста семнадцать) рублей 42 копейки",
