...
context = {'work' : "ремонту кабинета №7",
           'work_name': "Ремонт кабинета №7",
           ...
           'summ' : "93 000 (Девяносто три тысячи) рублей 00 копеек",
           'nds' : "в том числе НДС 20% - 15 500 (Пятнадцать тысяч пятьсот) рублей 00 копеек",
