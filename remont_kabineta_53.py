...
context = {'work' : "ремонту кабинета №53",
           'work_name': "Ремонт кабинета №53",
           ...
           'summ' : "36 000 (Тридцать шесть тысяч) рублей 00 копеек",
           'nds' : "в том числе НДС 20% - 6 000 (Шесть тысяч) рублей 00 копеек",
