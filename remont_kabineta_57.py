...
context = {'work' : "ремонту кабинета №57",
           'work_name': "Ремонт кабинета №57",
           ...
           'summ' : "86 000 (Восемьдесят шесть тысяч) рублей 00 копеек",
           'nds' : "в том числе НДС 20% - 14 133 (Четырнадцать тысяч сто тридцать три) рубля 33 копейки",
